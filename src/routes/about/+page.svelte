<div class="flex justify-center bg-[#222] w-full h-auto gap-4">
	<div class="flex flex-col px-32">
		...
		<div class="flex flex-col items-center">
			<div class="flex flex-row items-center">
				<img
					...
					class="w-32"
				/>
				<p class="text-6xl text-white font-normal mt-3 mx-4 mb-3 font-overpass">×</p>
				<svg viewBox="0 0 128 128" class="w-32 fill-[#ff3e00]">
					<path
						fill="#ff3e00"
		...
		<p class="text-xl text-white font-normal mt-10 mx-4 mb-3 font-overpass text-justify indent-10">
			...
			strikes a balance between providing essential features and maintaining a user-friendly
			experience. Whether you're exploring anime details or managing your watchlist, the website's
		...
		<p class="text-xl text-white font-normal my-3 mx-4 font-overpass text-justify indent-10">
			...
			performance, guaranteeing a smooth experience as users seamlessly navigate through the site.
		...
		<p class="text-xl text-white font-normal mt-3 mx-4 mb-10 font-overpass text-justify indent-10">
			...
			effortlessly explore anime details, manage watchlists, and discover new series without any
			unnecessary complexity. The integration of SvelteKit further refines the website's
			performance, offering enthusiasts a straightforward and efficient platform to immerse
			themselves in the world of anime. AniSvelte is not about over-engineering; it's about creating
			a welcoming and uncluttered space where anime lovers can connect and enjoy their passion with
			ease.
		</p>
	</div>
</div>
